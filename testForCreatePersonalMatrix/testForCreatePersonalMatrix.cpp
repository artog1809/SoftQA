...
namespace testForCreatePersonalMatrix
{
	TEST_CLASS(testForCreatePersonalMatrix)
	{
	public:
		...
		TEST_METHOD(threeBranches)
		{
			...
			m2[0][0].real(0.0);      m2[0][0].imag(0);
			m2[0][1].real(1.0);		 m2[0][1].imag(0);
			m2[0][2].real(-1.0);	 m2[0][2].imag(0);
			m2[1][0].real(220.0);     m2[1][0].imag(0);
			...
			int bc = 3;
			int num = 0;
			createPersonalMatrix(m1, z, u, num, bc);
			for (int i = 0; i < bc; i++)
			{
				for (int j = 0; j < bc; j++)
				{
		...
		TEST_METHOD(twoBranches)
		{
			...
			m2[0][1].real(0.0);		 m2[0][1].imag(0);
			m2[1][0].real(15.0);     m2[1][0].imag(0);
			m2[1][1].real(220.0);  m2[1][1].imag(0);
